...
class myPlayer(PlayerInterface):
    ...
    def __init__(self):
        ...
        self._horizon = 6 # <= réglage de la profondeur d'exploration souhaitée ou du temps de recherche en secondes
    ...
    def getPlayerMove(self):
        ...
        # move = self.firstAlphaBetaMax(self.computeParityScoreHeuristic, self._horizon)  # <== Change strategy HERE
        # move = self.negaMax(self.computeParityScoreHeuristic, 0, self._horizon, self._myColor)[1]  # <== Change strategy HERE
        # move = self.negAlphaBeta(self.computeParityScoreHeuristic, float("-inf"), float("inf"), 0, self._horizon, self._myColor)[1]  # <== Change strategy HERE
        # move = self.iterativeDeepening(self.computeUltimateScoreHeuristic, 6)  # <== Change strategy HERE
